...
config :currency_converter, :adapter, CurrencyConverter.FixerConverter

config :currency_converter, CurrencyConverter.FixerConverter,
  api_key: System.get_env("FIXER_API_KEY")
